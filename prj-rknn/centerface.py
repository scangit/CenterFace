...
class CenterFace(object):
    def __init__(self, height, width, landmarks=True):
        ...
        self.rknn = RKNN()
        self.rknn.load_rknn('../models/rknn/centerface.rknn')
        self.rknn.init_runtime(target='rk1808')    
    ...
    def __call__(self, img, threshold=0.5):
        ...
        if self.landmarks:
            [ heatmap, scale, offset, lms ] = [ o for i, o in enumerate(outputs) ]
        else:
            heatmap, scale, offset = [ o for i, o in enumerate(outputs) ]
